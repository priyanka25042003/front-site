                                ...
                                <div className="tab-content" id="nav-tabContent">
                                    <div className="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <div className="row row-cols-1 mx-1 row-cols-md-2 g-4">
                                            <div className="card mb-3 mt-3 ml-4 " style={{ maxWidth: "500px" }}>
                                    ...
                                    <div className="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-contactt-tab">
                                        <div className="row row-cols-1 mx-1 row-cols-md-2 g-4">
                                            <div className="card mb-3 mt-3 ml-4 " style={{ maxWidth: "500px" }}>
                                                <div className="row g-0 ">
                                                    <div className="col-md-4">
